...
EXPECTED_CLI_RUNTIME_VERSION = "0.19.5"
EXPECTED_TUTORIAL_RUNTIME_VERSION = "0.19.4"
EXPECTED_DELIVERIES_APP_CLI_VERSION = "2.2.2"
EXPECTED_CLI_UI_VERSION = "0.9.0"
EXPECTED_TUTORIAL_UI_VERSION = "0.6.5"
EXPECTED_MAPS_VERSION = "2.1.4"
EXPECTED_DELIVERIES_APP_VERSION = "2.0.7"
...
begin
  ...
  assert_file_contains(doc_page, "delivery app yet")
  ...
  assert_file_contains(doc_page, "city data generators")
  assert_file_contains(doc_page, "The CLI scaffold is a starting shell, not a generator for the complete")
  ...
  assert_file_contains(doc_page, "they are not the delivery-routing datasets")
  assert_file_contains(doc_page, "replaces the generated seed flow with app-owned city visits")
  ...
  if usecases_repo
    ...
    assert_file_contains(File.join(deliveries_bundle, "Cargo.toml"), "tokio = { version = \"1.52.3\", features = [\"full\"] }")
  ...
  if deliveries_repo
    ...
    assert_file_contains(File.join(deliveries_repo, "Cargo.toml"), "solverforge = { version = \"#{EXPECTED_TUTORIAL_RUNTIME_VERSION}\"")
