...
EXPECTED_HOSPITAL_APP_VERSION = "2.0.7"
...
begin
  ...
  assert_file_contains(doc_page, "hospital app yet")
  ...
  assert_file_contains(doc_page, "deterministic hospital")
  assert_file_contains(doc_page, "benchmark generator")
