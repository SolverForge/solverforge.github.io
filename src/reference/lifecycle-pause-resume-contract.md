...
contract is documented in the `solverforge 0.18.0` runtime docs, the published
`solverforge-cli 2.2.2` CLI docs, and the `solverforge-ui 0.7.0` UI docs; use
those pages for user-facing guidance.
<% end %>
