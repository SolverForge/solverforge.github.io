...
description: "Internal maintainer references, agent guides, and operational contracts for SolverForge maintainers and coding agents."
---

# Maintainer Notes

<%= render Ui::Callout.new(title: "Internal audience", variant: "warning") do %>
These pages are for SolverForge maintainers and coding agents. They tie
together the published docs site with the repo-local maintenance surfaces in
the source repositories. The site can mention those files, but it does not
...
How the published site fits with repo-local maintainer surfaces across `solverforge`, `solverforge-cli`, `solverforge-ui`, and `solverforge-maps`.
  <% end %>
  <%= render Ui::Card.new(title: "Ecosystem Agent Guide", href: relative_url('/reference/maintainers/ecosystem-agent-guide/'), icon: "fa-solid fa-robot") do %>
How coding agents should orient themselves across source-repo guidance and the published site.
  <% end %>
...
Human maintainer reference for the Bridgetown docs site, static search, and published information architecture.
  <% end %>
  <%= render Ui::Card.new(title: "Docs Site Agent Guide", href: relative_url('/reference/maintainers/docs-site-agent-guide/'), icon: "fa-solid fa-terminal") do %>
How coding agents should edit Bridgetown content, navigation, components, and search without breaking the published site.
  <% end %>
</div>
