...
draft: false
description: >
  solverforge-cli 2.0.x introduced the one neutral scaffold entry point,
  generator-driven model growth, and explicit scaffold-target reporting for the
  current SolverForge runtime, UI, and maps lines.
---
...
| Version | Date | Notes |
| ------- | ---- | ----- |
| `2.0.4` | 2026-05-05 | Scaffolds `solverforge 0.11.1`, `solverforge-ui 0.6.5`, `solverforge-maps 2.1.4`, and Rust `1.95`. |
| `2.0.2` | 2026-05-03 | Moved fresh generated apps to `solverforge 0.10.0` and `solverforge-ui 0.6.4`. |
| `2.0.1` | 2026-04-26 | Refreshed generated apps to `solverforge 0.9.1`, `solverforge-ui 0.6.3`, and Rust `1.95`. |
| `2.0.0` | 2026-04-24 | Introduced the neutral `solverforge new` shell, generator-driven model growth, and explicit target reporting. |
