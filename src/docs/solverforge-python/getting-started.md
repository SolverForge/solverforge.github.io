...
Install the published `solverforge 0.6.6` package:

```bash
python3.14 -m venv .venv
. .venv/bin/activate
python -m pip install --upgrade pip
python -m pip install "solverforge==0.6.6"
```
...
The version printed for either installation path should be `0.6.6`.
...
compiled into the SolverForge 0.19.4 runtime graph; Python-authored models do not
