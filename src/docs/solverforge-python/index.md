...
This section documents the tagged `solverforge-py 0.6.6` source line for
CPython 3.14. The automatic release workflow completed and the public PyPI
package is `solverforge 0.6.6`. The source compiles Python models into the
`solverforge 0.19.4` Rust runtime and embeds `solverforge-ui 0.7.0` assets for
...
| Documented source line | `0.6.6` |
| Published PyPI version | `0.6.6` |
| Python requirement | `>=3.14` |
| Runtime base | `solverforge 0.19.4` |
...
- [PyPI package 0.6.6](https://pypi.org/project/solverforge/0.6.6/)
- [Python v0.6.6 source](https://github.com/SolverForge/solverforge-py/tree/v0.6.6)
