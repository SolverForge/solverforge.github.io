...
Write Python models with explicit decorators, metadata, and callbacks, then compile them into the native SolverForge runtime from PyPI or the tagged source line.
  <% end %>
</div>
