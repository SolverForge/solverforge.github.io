...
| `src/generated/data_seed.rs` | Compiler-owned demo-data builder rewritten by `solverforge generate data` |
...
| `src/generated/data_seed.rs` | CLI | Rewritten by `solverforge generate data`; do not hand-edit if you plan to regenerate |
...
## `src/data/mod.rs` vs `src/generated/data_seed.rs`

The scaffold intentionally splits demo-data ownership:

- `src/generated/data_seed.rs` is generator-owned
...
Those overrides are applied before the built-in generator fallback is used.
