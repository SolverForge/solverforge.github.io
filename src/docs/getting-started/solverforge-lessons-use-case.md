...
The tagged `solverforge-lessons@2.0.6` use-case source targets the published
...
`solverforge-cli 2.2.3` now scaffolds `solverforge 0.19.3`; the finished Lessons
app records the same runtime target while retaining its original `2.2.2`
scaffold provenance:
...
| Tagged app release | `solverforge-lessons@2.0.6` |
