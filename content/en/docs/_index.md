...
- **[SolverForge](solverforge/)** — Native Rust constraint solver (v0.5.18)
- **[solverforge-maps](solverforge-maps/)** — Road-network and routing utilities for VRP and dispatch applications
